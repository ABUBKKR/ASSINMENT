// Your list of guests
let guests: string[] = ['Alice', 'Bob', 'Carol'];

// Guest who can't make it
let guest_cant_make_it: string = 'Bob';
console.log(`Unfortunately, ${guest_cant_make_it} can't make it to the dinner.`);

// New guest to invite
let new_guest: string = 'David';

// Find the index of the guest who can't make it
let index_of_guest_cant_make_it: number = guests.indexOf(guest_cant_make_it);
